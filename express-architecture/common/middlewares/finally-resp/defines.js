...
const base = [
  ...
  {statusCode: 200, succeed: true, code: 200, status: '', desc: ''},
  {statusCode: 500, succeed: false, code: 500, status: '', desc: '内部错误'},
  {statusCode: 404, succeed: true, code: 404, status: '', desc: '页面不存在'}
];
